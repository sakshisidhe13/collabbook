          ...
          <div className="grid md:grid-cols-2 gap-10 my-10">
            <div>
              ...
              <div className="mt-6 space-y-6">
                ...
                <div className="p-4 bg-base-100 shadow-lg rounded-lg">
                  <h4 className="text-lg font-semibold">4. Collaborate</h4>
                  <p className="text-gray-500">
                    Connect with your friends through this. Providing Real-time edit access 
            ...
            <div>
              ...
              <div className="mt-6 space-y-6">
                ...
                <div className="p-4 bg-base-100 shadow-lg rounded-lg">
                  <h4 className="text-lg font-semibold">Share and Collaborate</h4>
                  <p className="text-gray-500">
                    You get the control on what entries you wish to share with Your
                    friends, tell your friends how you feel! 
                  </p>
                </div>
              </div>
            </div>
